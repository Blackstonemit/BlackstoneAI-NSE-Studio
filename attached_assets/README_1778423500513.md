...
| **Scalping Pro** | High-speed 1-min execution board, 1-click scalp entries, active position monitoring, and rapid square-offs |
| **Paper Trading** | Virtual portfolio with ₹10,00,000 starting margin, real-time MTM (Unrealized P&L), trade history, and account reset |
...
| **Advanced Technicals** | Server-side computed RSI, MACD, SMA, EMA, BB, ATR, Stochastic, ADX, OBV, VWAP, SuperTrend, Fibonacci, **INDIAVIX**, **Session POC**, **Aroon**, **STC**, and **Klinger** |
...
- **Primary model:** NVIDIA Qwen (via `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`)
...
| `portfolio` | Stores paper trading account balances (e.g., ₹10,00,000 margin) |
| `paper_trades` | Trade history log and active positions for paper trading |

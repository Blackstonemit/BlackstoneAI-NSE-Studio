...
function AddSymbolPopover({
  ...
  return (
    ...
    >
      <div
        className="bg-card border border-border rounded-sm shadow-2xl w-full max-w-md mx-4"
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0 text-xs font-mono">
                    ...
                    <span className="border border-border rounded px-1 py-0.5 text-muted-foreground/60">
                      {r.type}
                    </span>
...
export default function Dashboard() {
  ...
  useEffect(() => {
    fetchPinnedQuotes(pins);
  }, [pins, fetchPinnedQuotes]);
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={cn(
                            'font-mono text-sm',
                            g.changePercent >= 0 ? 'text-success' : 'text-destructive',
                          )}
                        >
                          {g.changePercent >= 0 ? '+' : ''}

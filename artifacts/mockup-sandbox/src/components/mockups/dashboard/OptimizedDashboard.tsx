...
const INDICES = [
  {
    ...
    high: 24196,
    low: 24040,
    sparkline: [23900, 23980, 23850, 24020, 24100, 23950, 24050, 24150, 24110, 24081],
  },
  {
    symbol: 'BANKNIFTY',
    name: 'BANK NIFTY',
    ...
    high: 52100,
    low: 51700,
    sparkline: [51600, 51800, 51500, 51900, 52000, 51800, 51700, 51900, 51870, 51843],
  },
  {
    symbol: 'FINNIFTY',
    name: 'FINNIFTY',
    ...
    high: 24100,
    low: 23900,
    sparkline: [24000, 24050, 23900, 24020, 24100, 23950, 23980, 23970, 23960, 23956],
  },
  {
    symbol: 'SENSEX',
    name: 'SENSEX',
    ...
    high: 79600,
    low: 79100,
    sparkline: [79000, 79200, 79100, 79300, 79450, 79200, 79350, 79400, 79320, 79332],
  },
];

const GAINERS = [
  { symbol: 'ADANIENT', price: 2845.6, pct: 4.32 },
  { symbol: 'HCLTECH', price: 1624.45, pct: 2.87 },
  { symbol: 'WIPRO', price: 498.3, pct: 2.14 },
  { symbol: 'SBILIFE', price: 1521.75, pct: 1.93 },
  { symbol: 'LTIM', price: 5876.2, pct: 1.72 },
];

const LOSERS = [
  { symbol: 'BAJFINANCE', price: 7124.5, pct: -2.41 },
  { symbol: 'POWERGRID', price: 291.8, pct: -1.89 },
  { symbol: 'NTPC', price: 354.25, pct: -1.54 },
  { symbol: 'BPCL', price: 323.4, pct: -1.32 },
...
const SIGNALS = [
  {
    ...
    tf: 'INTRADAY',
    rationale:
      'RSI oversold bounce + MACD crossover above signal line. Volume spike confirms breakout.',
  },
  {
    action: 'SELL',
    symbol: 'BAJFINANCE',
    display: 'BAJFINANCE · NSE',
    entry: 7124.5,
    target: 6980.0,
    sl: 7200.0,
    conf: 74,
    tf: 'INTRADAY',
    rationale:
      'Bearish engulfing at resistance. Stochastic overbought (92/88). BB upper band touch.',
  },
  {
    action: 'BUY',
    symbol: 'HCLTECH',
    ...
    conf: 81,
    tf: 'SWING',
    rationale: 'EMA 9 > EMA 21 crossover. ADX strengthening at 28. Strong delivery volume.',
  },
];
...
const NAV_GROUPS = [
  ...
  {
    label: 'DERIVATIVES',
    items: [{ label: 'Options Chain' }, { label: 'Futures' }],
  },
  {
    label: 'ANALYSIS',
    items: [
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <svg
              ...
              strokeLinecap="round"
            >
              <polyline points="2,9 6,5 9,8 13,3" />
            </svg>
          </div>
          <span
            style={{
        ...
        >
          ...
          />
          <span style={{ fontSize: 10, color: 'hsl(215 20% 50%)', letterSpacing: '0.12em' }}>
            MARKET CLOSED
          </span>
          <span style={{ marginLeft: 'auto', fontSize: 10, color: 'hsl(215 20% 40%)' }}>
            {ist} IST
          </span>
        </div>
                  ...
                  >
                    <div
                      style={{
                        ...
                        border: `1.5px solid ${active ? 'hsl(217 91% 60%)' : 'hsl(215 20% 30%)'}`,
                      }}
                    />
                    {item.label}
        ...
        <div style={{ padding: '10px 16px', borderTop: '1px solid hsl(217 33% 11%)' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              />
              <span style={{ fontSize: 10, color: '#22c55e', letterSpacing: '0.1em' }}>
                SYSTEM ONLINE
              </span>
            </div>
            <div style={{ fontSize: 10, color: 'hsl(215 20% 40%)' }}>
              LATENCY: <span style={{ color: '#22c55e' }}>12ms</span>
            </div>
          </div>
        </div>
      </aside>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ fontSize: 11, color: 'hsl(215 20% 35%)' }}>
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            >
              <svg
                ...
                strokeLinecap="round"
              >
                <path d="M10 5.5A4.5 4.5 0 0 1 2 8M1 5.5A4.5 4.5 0 0 1 9 3" />
              </svg>
              <span>60s</span>
            </div>
            {/* Clock */}
        ...
        {/* Page content */}
        <main
          style={{ flex: 1, padding: '16px 20px', maxWidth: 1600, margin: '0 auto', width: '100%' }}
        >
          {/* Page header */}
          <div
            style={{
          ...
          >
            <h1 style={{ fontSize: 15, fontWeight: 700, letterSpacing: '0.12em', color: '#fff' }}>
              LIVE DASHBOARD
            </h1>
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        height: 1,
                        background: up
                          ? 'linear-gradient(90deg, hsl(142 71% 45% / 0.6) 0%, transparent 100%)'
                          : 'linear-gradient(90deg, hsl(0 84% 60% / 0.5) 0%, transparent 100%)',
                      }}
                    />
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                        ...
                        <span
                          style={{
                            color: up ? 'hsl(142 60% 40%)' : 'hsl(0 60% 50%)',
                            fontSize: 10,
                          }}
                        >
                          {up ? '+' : ''}
                    ...
                    >
                      <span>
                        ...
                        <span style={{ color: 'hsl(215 20% 50%)' }}>
                          {idx.high.toLocaleString('en-IN')}
                        </span>
                      </span>
                      <span>
                        L:{' '}
                        <span style={{ color: 'hsl(215 20% 50%)' }}>
                          {idx.low.toLocaleString('en-IN')}
                        </span>
                      </span>
                    </div>
                  </div>
          ...
          {/* ── MOVERS + BREADTH ─────────────────────────────────── */}
          <div
            style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: 8, marginBottom: 14 }}
          >
            {/* Gainers / Losers */}
            <div
              style={{
                  ...
                  {GAINERS.map((g) => (
                    <div
                      ...
                      style={{
                        ...
                        justifyContent: 'space-between',
                        padding: '7px 14px',
                        borderBottom: '1px solid hsl(217 33% 8%)',
                      }}
                    >
                      <div>
                        ...
                        <div style={{ fontSize: 10, color: 'hsl(215 20% 40%)' }}>
                          ₹{g.price.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                        </div>
                      </div>
                  ...
                  {LOSERS.map((l) => (
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontSize: 10, color: 'hsl(215 20% 40%)' }}>
                          ₹{l.price.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                        </div>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            >
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  ...
                  >
                    <span>Analyzed</span>
                    <span style={{ color: 'hsl(215 20% 60%)' }}>{total} symbols</span>
                  </div>
                  <div
                    style={{
                      height: 6,
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {[
                    ...
                    >
                      <span style={{ fontSize: 10, color: item.color, letterSpacing: '0.1em' }}>
                        {item.label}
                      </span>
                      <span style={{ fontSize: 13, fontWeight: 700, color: item.color }}>
                        {item.val}
                        <span
                          style={{ fontSize: 9, fontWeight: 400, color: item.color, opacity: 0.7 }}
                        >
                          %
                        </span>
                      </span>
          ...
          >
            ...
            >
              ...
              <span style={{ marginLeft: 'auto', fontSize: 9, color: 'hsl(215 20% 35%)' }}>
                CONFIDENCE ·
              </span>
                ...
                >
                  ...
                  <div style={{ minWidth: 120 }}>
                    ...
                    <div style={{ display: 'flex', gap: 6, marginTop: 2 }}>
                      <span
                        style={{ fontSize: 9, color: 'hsl(215 20% 40%)', letterSpacing: '0.05em' }}
                      >
                        NSE
                      </span>
                      <span
                  ...
                  <div style={{ flex: 1, maxWidth: 100 }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: 9, color: actionColor, fontWeight: 600 }}>
                        {sig.conf}%
                      </span>
                    </div>
                    <div
                  ...
                  <div style={{ display: 'flex', gap: 20, marginLeft: 'auto' }}>
                    {[
                      ...
                      <div key={p.label} style={{ textAlign: 'right' }}>
                        ...
                        <div
                          style={{ fontSize: 12, fontWeight: 600, color: p.color, marginTop: 1 }}
                        >
